...
abstract public class AudioContent
{
  ...
  // Play the content via the audio file
	...
	public boolean equals(Object other)
	{
		...
		return this.title.equals(otherCon.title) && this.id.equals(otherCon.id);		//cast other to audiocontent to be compared by title & id
	}
